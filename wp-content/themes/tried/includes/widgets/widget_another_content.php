...
class widget_another_content extends WP_Widget {
    function __construct() {
		parent::__construct(
			'widget_another_content', 'Tried Another Content',
			array(
				'classname' => 'widget_another_content',
				'description' => '',
...
<section id="widget-<?php echo $args['widget_id']; ?>" class="section-another-content">
    <div class="section-wrapper margin-auto">
        ...
        <div class="content-block">
            ...
            <a class="content-collapse" href="javascript:void(0)" title="<?php _e( 'Show more/Show less', 'tried' ); ?>"
