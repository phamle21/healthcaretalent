...
if (!class_exists('mk_file_folder_manager')):
    class mk_file_folder_manager
    {
        ...
        const FILE_MANAGER_VERSION = '8.3.8';
       ...
       */
        ...
        */
        public function mk_file_folder_manager_action_callback()
        {
            ...
            $fm_user_roles = is_array( $settings['fm_user_roles'] ) ? $settings['fm_user_roles'] : [] ;
            if ( $role != 'administrator' && ! in_array( $role, $fm_user_roles ) ) {
                echo __( 'You are not authorized to perform this action.', 'wp-file-manager-pro' ) ; die ;
            }
